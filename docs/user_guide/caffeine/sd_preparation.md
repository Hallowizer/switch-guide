...
!!! tip ""
    ...
    - If you plan on using emuMMC, you will also need <a href="https://github.com/suchmememanyskill/TegraExplorer/releases" target="_blank">TegraExplorer</a> (Download `TegraExplorer.bin`) 
...
!!! tip ""
    ...
    9. If you downloaded TegraExplorer, place `TegraExplorer.bin` in `/bootloader/payloads`
...
#### [Continue to Using PegaScape <i class="fa fa-arrow-circle-right fa-lg"></i>](pegascape.md)
