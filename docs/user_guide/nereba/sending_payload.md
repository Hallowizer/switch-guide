...
!!! tip ""
    ...
    - The latest release of <a href="https://github.com/noahc3/fakenews-injector/releases/" target="_blank">Fake News Injector</a>
...
#### [Continue to Injecting Fake News] <i class="fa fa-arrow-circle-right fa-lg"></i>](pegascape.md#)
